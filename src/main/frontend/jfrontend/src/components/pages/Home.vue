<template>
  ...
  <main class="p-4 h-auto mx-auto max-w-screen-lg">
    <h1 class="mb-4 text-3xl font-extrabold text-gray-900 dark:text-white md:text-5xl lg:text-6xl">
      <span class="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">Better Data</span> Scalable
      AI.
    </h1>
...
const endItem = computed(() => Math.min(currentPage.value * itemsPerPage, books.value.length));
...
onMounted(() => {
  fetchBookDetails();
  console.log("The books ",books.value)
});
</script>
